        ...
        <div class="tree-content phonebind">
            <div class="m-withe">
                ...
                <div class="phonebindcontent st2">
                    ...
                    <div class="stepimg"><img src="{{ asset('res/images/steppassword1.png')}}"> </div>
                    ...
                    <div class="list save">
                        <a class="btn fit  defaul btn-red" id="button-one"  role="button">下一步</a>
                    </div>
