...
<script type="text/javascript">
  ...
  function fun() {
    if (i == 0) {
    window.location.href = "{{ url('user/financial_pay')}}?order_id={{ $order->id }}";
...
<body>
  <div class="content">
    ...
    <span><i class="iconfont">&#xe605;</i>当前位置>财务管理><em>订单操作</em></span>
    </div>
    <div class="tree-content">
      ...
      <div class="successpadding">
          <div class="successbk">
              ...
              <a class="btn line btn-default lookdetail" href="{{ url('user/financial_pay')}}?order_id={{ $order->id }}" role="button">点击返回</a>
          </div>
