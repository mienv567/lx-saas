        ...
        <div class="tree-content system_list">
            <div class="m-withe">
                ...
                <div class="article_list_content" style="padding-top:20px;">
                    <div class="tabcontent active" rel="1">
                        <div class="articlelisttable">
                            <table class="table table-hover">
                                ...
                                <tr onclick="javascript:window.location.href='{{url('user/bulletin_detail')}}?id={{$item->id}}'">
                    ...
                    @if($bulletins){!!$bulletins->appends(['title'=>$search_title])->render()!!}@endif
                        </ul>
                    </div>
                </div>
            </div><!--m-withe end-->
