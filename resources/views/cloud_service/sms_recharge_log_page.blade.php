...
<div class="financialist4">
  @if ($recharges->hasMorePages() == 1 || $recharges->currentPage() != 1)
    <a class="btn defaul  btn-default f_r" href="javascript:loadSmsRecharLogSelectedPage('sms_recharge_log?uid={{$uid}}&put_recharge_start_time={{ $rechargeStartTime }}&put_recharge_end_time={{ $rechargeEndTime }}&page=');" role="button">GO</a>
