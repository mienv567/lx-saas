...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('res/css/weixinafter.css')}}" />
...
<div class="layout-main">
    <div class="layout-left">
        <div class="nav">
            <div class="navlist">
                <a class="{{ ($menuIndex == 0) ? 'active' : '' }}" href="{{ url($uriPrefix.'/') }}">
            ...
            <div class="navlist">
                <a class="{{ ($menuIndex == 2) ? 'active' : '' }}" href="{{ url($uriPrefix.'/sms_user') }}">
