...
namespace {
    ...
    class PhpSms extends \Toplan\PhpSms\Facades\Sms{
         ...
         * @static 
         */
        public static function template($agentName, $tempId = null){
            return \Toplan\PhpSms\Sms::template($agentName, $tempId);
        }
        ...
        public static function getData(){
            return \Toplan\PhpSms\Sms::getData();
        }
        ...
        public static function generatorTask(){
            return \Toplan\PhpSms\Sms::generatorTask();
        }
         ...
         * @static 
         */
        public static function getSmsAgent($name, $configData){
            return \Toplan\PhpSms\Sms::getSmsAgent($name, $configData);
        }
        ...
        public static function enable($agentName, $options = null){
            return \Toplan\PhpSms\Sms::enable($agentName, $options);
        }
         ...
         * @static 
         */
        public static function agents($agentName, $config = array()){
            return \Toplan\PhpSms\Sms::agents($agentName, $config);
        }
        ...
        public static function getEnableAgents(){
            return \Toplan\PhpSms\Sms::getEnableAgents();
        }
        ...
        public static function getAgentsConfig(){
            return \Toplan\PhpSms\Sms::getAgentsConfig();
        }
        ...
        public static function cleanEnableAgents(){
            return \Toplan\PhpSms\Sms::cleanEnableAgents();
        }
        ...
        public static function cleanAgentsConfig(){
            return \Toplan\PhpSms\Sms::cleanAgentsConfig();
        }
        
        /**
         * get a serializer
         *
         * @return \Toplan\PhpSms\Serializer 
         * @static 
         */
        public static function getSerializer(){
            return \Toplan\PhpSms\Sms::getSerializer();
        }
    ...
    class SmsManager extends \Toplan\Sms\Facades\SmsManager{
        ...
        public static function getSentInfo(){
            return \Toplan\Sms\SmsManager::getSentInfo();
        }
         ...
         * @static 
         */
        public static function setSentInfo($key, $data = null){
            return \Toplan\Sms\SmsManager::setSentInfo($key, $data);
        }
         ...
         * @static 
         */
        public static function storeSentInfo($token, $data = array()){
            return \Toplan\Sms\SmsManager::storeSentInfo($token, $data);
        }
        ...
        public static function retrieveSentInfo($token = null){
            return \Toplan\Sms\SmsManager::retrieveSentInfo($token);
        }
        ...
        public static function forgetSentInfo($token = null){
            return \Toplan\Sms\SmsManager::forgetSentInfo($token);
        }
         ...
         * @static 
         */
        public static function hasRule($name, $ruleName){
            return \Toplan\Sms\SmsManager::hasRule($name, $ruleName);
        }
         ...
         * @static 
         */
        public static function getRealMobileRule($ruleAlias = '', $token = null){
            return \Toplan\Sms\SmsManager::getRealMobileRule($ruleAlias, $token);
        }
         ...
         * @static 
         */
        public static function getUsedRuleAlias($name){
            return \Toplan\Sms\SmsManager::getUsedRuleAlias($name);
        }
         ...
         * @static 
         */
        public static function setUsedRuleAlias($name, $value){
            return \Toplan\Sms\SmsManager::setUsedRuleAlias($name, $value);
        }
        ...
        public static function retrieveMobileRule($token, $name = null){
            return \Toplan\Sms\SmsManager::retrieveMobileRule($token, $name);
        }
         ...
         * @static 
         */
        public static function isCheck($name = 'mobile'){
            return \Toplan\Sms\SmsManager::isCheck($name);
        }
         ...
         * @static 
         */
        public static function getVerifySmsTemplates(){
            return \Toplan\Sms\SmsManager::getVerifySmsTemplates();
        }
        ...
        public static function getVerifySmsContent(){
            return \Toplan\Sms\SmsManager::getVerifySmsContent();
        }
        ...
        public static function generateCode($length = null, $characters = null){
            return \Toplan\Sms\SmsManager::generateCode($length, $characters);
        }
        ...
        public static function getCodeValidTime(){
            return \Toplan\Sms\SmsManager::getCodeValidTime();
        }
         ...
         * @static 
         */
        public static function setResendTime($token, $seconds = 60){
            return \Toplan\Sms\SmsManager::setResendTime($token, $seconds);
        }
         ...
         * @static 
         */
        public static function canSend($token = null){
            return \Toplan\Sms\SmsManager::canSend($token);
        }
         ...
         * @static 
         */
        public static function validator($input, $rule = ''){
            return \Toplan\Sms\SmsManager::validator($input, $rule);
        }
